    ...
    public static class DbInitializer
    {
        public static void Initialize(TechShareDbContext context)
        {
            ...
            context.Users.AddRange(
                new User{ Username="chumayvip@gmail.com", PasswordHash="123456", FullName="Phạm Gia Phú", PhoneNumber="0123456789", StudentId="SV001", ReputationScore = 5.0f },
                new User{ Username="khachthue", PasswordHash="123456", FullName="Dương Chí Kiệt", PhoneNumber="0987654321", StudentId="SV002", ReputationScore = 4.5f }
            );
            context.SaveChanges();
